        ...
        <div class="navbar-fixed scrollspy" id="navbar">
              ...
              <div class="container">
                <div class="nav-wrapper">
                  ...
                  <ul class="right hide-on-med-and-down">
                    ...
                    <li><a href="<?= base_url(); ?>presets">Buy Presets</a></li>
                    <li><a href="<?= base_url(); ?>booking">Booking</a></li>
                    <li><a href="<?= base_url(); ?>login/logout">Logout (<?= $user['nicknamedb'];?>)</a></li>
                </ul>
                </div>
             </div>
            </nav>
          ...
          <div class="slider">
            ...
            <section id='urban' class="urban grey darken-1 scrollspy">>
             ...
             <!-- Presets Urban  -->
             <section id="preseturban" class="preseturban grey darken-3">
