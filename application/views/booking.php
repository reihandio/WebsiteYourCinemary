 ...
 <!--Registration Form-->
    <div class="row booking">
        <div class="col s12 l7 offset-l3">
            <form class="booking" method="post" action="<?= base_url('booking'); ?>">
                <div class="card-panel">
                    <h5>Set a Book Date</h5>
                    ...
                    <div class="input-field">
                        ...
                        <label>Presets</label>
                        <?= form_error('packet', '<small class="text-danger">', '</small>');?>
                    </div>

                    <!-- <div class="form-field">
                        <label for="packet">Packet Name</label>
                        <input type="text" id="packet" name="packet" class="validate">
                        <?= form_error('packet', '<small class="text-danger">', '</small>');?>
                    </div><br> -->
